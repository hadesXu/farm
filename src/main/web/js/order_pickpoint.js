function show(o,sid){ 
	...
	var pid = document.getElementById('point'+sid).value;
	 Ajax.call('http://www.52wnc.com/mobile/js/flow.php?step=select_pickinfo', 'sid=' + sid + '&pid='+pid, pickinfo, 'POST', 'JSON');
...
function save_point(suppid){
	var value = $('#s_pid').val();
	Ajax.call('http://www.52wnc.com/mobile/js/flow.php?step=save_point', 'sid=' + suppid + '&pid='+value, selectpickinfo, 'GET', 'JSON');
	close_pop();
}
