...
function checkEmailExist(email, callback) {
	...
	$.post('http://www.52wnc.com/mobile/js/register.php?act=check_email_exist', {
		email: email
	}, function(result) {
		if (result == 'false') {
...
function checkMobilePhoneExist(mobile, callback) {
	...
	$.post('http://www.52wnc.com/mobile/js/register.php?act=check_mobile_exist', {
		mobile: mobile
	}, function(result) {
...
function sendEmailCode(emailObj, emailCodeObj, sendButton) {
	checkEmail(emailObj, function(result) {
		if (result) {
			// 发送邮件
			var url = 'http://www.52wnc.com/mobile/js/register.php?act=send_email_code&XDEBUG_SESSION_START=ECLIPSE_DBGP';
...
function sendMobileCode(mobileObj, mobileCodeObj, sendButton) {
	checkMobilePhone(mobileObj, function(result) {
		if (result) {
			// 发送邮件
			var url = 'http://www.52wnc.com/mobile/js/register.php?act=send_mobile_code';
