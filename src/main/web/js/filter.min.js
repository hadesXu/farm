var bizFilter = {
	bizCateHtml: [],
	bizAttHtml: [],
	req_url: "http://www.52wnc.com/mobile/themesmobile/68ecshopcom_mobile/js/category.php",
	...
	initDom: function() {
		...
		this.req_url = 0 < window.location.href.indexOf("http://www.52wnc.com/mobile/themesmobile/68ecshopcom_mobile/js/search.php") ? "http://www.52wnc.com/mobile/themesmobile/68ecshopcom_mobile/js/search.php" : "http://www.52wnc.com/mobile/themesmobile/68ecshopcom_mobile/js/category.php";
	...
	partShow: function() {
		...
		0 == b.children("http://www.52wnc.com/mobile/themesmobile/68ecshopcom_mobile/js/li.on").length && b.show().children("li").slice(12).hide();
		0 == c.children("http://www.52wnc.com/mobile/themesmobile/68ecshopcom_mobile/js/li.on").length && c.show().children("li").slice(12).hide()
	},
