...
public class Constant {
    ...
    public static final String WITHDRAW_TIME = "09:00-17:30";
    ...
    //一个蛋的积分率
    public static final BigDecimal EGG_INTEGRAL_RATE = new BigDecimal("0.115");
    //一个鸭的积分率
    public static final BigDecimal DUCK_INTEGRAL_RATE = new BigDecimal("0.035");
    //卖出鸭的手续费
