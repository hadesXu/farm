...
public class TDuckWarehouse {
    ...
    public TDuckWarehouse(Long id, Long userId, Integer duck, Integer duckDoing, Integer egg, Integer eggFreeze, Integer eggHarvest, Integer ifHarvest, Integer ifSteal, Integer allSell, BigDecimal allProfit, BigDecimal allIntegral, BigDecimal food, Date addTime, Date updateTime) {
        this.id = id;
        this.userId = userId;
        this.duck = duck;
