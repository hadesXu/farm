...
public class TAccountTicket {
    ...
    public TAccountTicket(Long userId, BigDecimal balance, BigDecimal frozen, BigDecimal accRecharge, BigDecimal accWithdraw, BigDecimal accProfit, BigDecimal accCommission, Date addTime) {
        this.userId = userId;
