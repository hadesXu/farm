...

{
  ...
  if (formBuy){
    ...
    Ajax.call('http://www.52wnc.com/mobile/js/flow.php?step=add_to_cart', 'goods=' + $.toJSON(goods), addToCartResponse, 'POST', 'JSON');
}
...
function addToCartResponse(result)
{
  if (result.error > 0)
  {
    ...
    else if (result.error == 999 )
    {
       ...
       {
            location.href = 'http://www.52wnc.com/mobile/js/user.php';
	}
	...
	var cartInfo1 = document.getElementById('ECS_CARTINFO1');
        var cart_url = 'http://www.52wnc.com/mobile/js/flow.php?step=cart';
...

{
  ...
  Ajax.call('http://www.52wnc.com/mobile/js/user.php?act=collect', 'id=' + goodsId, collectResponse, 'GET', 'JSON');
...

{
  ...
  Ajax.call('http://www.52wnc.com/mobile/js/comment.php?act=gotopage', 'page=' + page + '&id=' + id + '&type=' + type, gotoPageResponse, 'GET', 'JSON');
...

{
  ...
  Ajax.call('http://www.52wnc.com/mobile/js/goods.php?act=gotopage', 'page=' + page + '&id=' + id, gotoBuyPageResponse, 'GET', 'JSON');
...

{
  ...
  Ajax.call('http://www.52wnc.com/mobile/js/user.php?act=send_hash_mail', '', sendHashMailResponse, 'GET', 'JSON')
...

{
...

    {
        ...
        document.forms['wholesale_goods'].action = "http://www.52wnc.com/mobile/js/wholesale.php";
...

  {
...

    {
      ...
      $$('pmlayer').innerHTML = '<div style="width: 800px; background: #666666; margin: 5px auto; text-align: left">' +
        ...
        '<a href="###" onclick="pmwin(\'close\')"><img style="position: absolute; right: 20px; top: 15px" src="close.gif"/*tpa=http://www.52wnc.com/mobile/js/images/close.gif*/ title="关闭" /></a>' +
...

    {
        ...
        pmframe.location = 'http://www.52wnc.com/mobile/js/pm.php';
...
function addPackageToCart(packageId)
{
  ...
  Ajax.call('http://www.52wnc.com/mobile/js/flow.php?step=add_package_to_cart', 'package_info=' + $.toJSON(package_info), addPackageToCartResponse, 'POST', 'JSON');
...

  {
...

    {
...

      {
        ...
        location.href = 'http://www.52wnc.com/mobile/js/user.php?act=add_booking&id=' + result.goods_id;
...

{
  ...
  newMask.style.opacity = "http://www.52wnc.com/mobile/js/0.40";
...
function chat_online(data){
	...
	$.post('http://www.52wnc.com/mobile/js/chat.php', {act: 'check_login'}, function(result){
		if(result == 'false'){
			window.location.href = "http://www.52wnc.com/mobile/js/chat.php";
		}else{
			var param = "";
			...
			//window.open ('chat.php?act=chat' + param,'newwindow','height=460,width=685,top='+top_+',left='+left+',toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
			 window.location.href = 'http://www.52wnc.com/mobile/js/chat.php?act=chat' + param;
		}
	}, 'text');
...
function deleteCollection(goods_id){
    if(confirm("确定要删除吗？")){
        Ajax.call('http://www.52wnc.com/mobile/js/user.php?act=delete_collection', 'collection_id=' + goods_id, deleteCollectionResponse, 'POST', 'JSON');
    }
}

function deleteCollectionResponse(result){
        alert(result.message);
        window.location.href = 'http://www.52wnc.com/mobile/js/user.php?act=collection_list/n';
}
...
function deleteFollow(shop_id){
    if(confirm("确定要删除吗？")){
        Ajax.call('http://www.52wnc.com/mobile/js/user.php?act=del_follow', 'rec_id=' + shop_id, deleteFollowResponse, 'POST', 'JSON');
    }
}

function deleteFollowResponse(result){
        alert(result.message);
        window.location.href = 'http://www.52wnc.com/mobile/js/user.php?act=follow_shop/n';
}