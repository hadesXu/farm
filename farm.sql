...
CREATE TABLE `t_account_ticket_flow` (
  ...
  `type` INT(2) NOT NULL COMMENT '1.购买种鸭 2.购买种蛋 3.充值 4.提现 5.出售商品鸭 6.出售商品蛋 7.购买饲料 8.佣金 9.购买看门狗 10.购买机器人 11.兑换菜币',
...
CREATE TABLE `t_duck_warehouse` (
  ...
  `all_integral` decimal(18,2) DEFAULT '0.00' COMMENT '累计出售商品蛋菜币',
...
CREATE TABLE `t_egg_warehouse` (
  ...
  `all_integral` decimal(18,2) DEFAULT '0.00' COMMENT '累计出售商品鸭菜币',
  `add_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
